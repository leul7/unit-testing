...
public class Circle {
    ...
    public double calculateArea() {
       /**
        * The code given below has bug and we need to fix it.
        * It basically returns 2*myRadious*PI. 
        */
        //return 2 * myRadius * Math.PI; 
        
        /**
         * The correct formula to calculate the area is PI*R^2
         */
        return myRadius * myRadius * Math.PI;
        
        // OR return Math.pow(myRadius, 2)*Math.PI; 
    }
